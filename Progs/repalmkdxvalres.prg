...
TIT_KdxRes()
STORE 0 TO lnTotAnt,lnTotIng,lnTotSal,lnTotSld
SELE TmpRep
DO WHILE !EOF()
	R = R + 1
	IF R > 55
	...
	@R,057 SAY CanAnt PICTURE "@Z 999,999.999"
	@R,069 SAY ImpAnt PICTURE "@Z 999.999999"
	@R,080 SAY TotAnt PICTURE "@Z 9999,999.99"
...
@R,080 SAY lnTotAnt PICTURE "9999,999.99"
