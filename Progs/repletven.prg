...
*         1         2         3         4         5         6         7         8         9         0         1         2         3
*123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012
*Vencmto    Letra           Mnd     Importe       Rango1        Rango2      Rango3       Rango4      Rango5  Sit Ubicacion    Tipo
*                                                   Al 
*                                                 Rango1                                            
*12/12/1234 123456789012345 123 1234,123.12  1234,123.12  12134,123.12 1234,123.12  1234,123.12  1234,123.12 123 123456789012 1234567     

PARAMETERS ldFecIni,ldFecFin,ldFecIni1,ldFecFin1,ldFecIni2,ldFecFin2,ldFecIni3,ldFecFin3,ldFecIni4,ldFecFin4
PUBLIC lnPag, R
LOCAL lcFile, lcProceso
lcFile = "LetVen"
lcProceso = "Rep_LetVen()"
lnPag = 0
R = 0
Imprimetexto(lcFile,lcProceso)
RETURN

PROCEDURE REP_LetVen
...
DO WHILE !EOF()
	...
	ENDIF
	@R,001 SAY FecVen
	@R,012 SAY PADR(NroDoc,15)
	@R,028 SAY Simbol
	@R,032 SAY ImpOrg PICTURE "9999,999.99"
	...
	@R,109 SAY PADR(Situacion,3)
	@R,113 SAY PADR(Ubicacion,12)
	@R,126 SAY PADR(TipUbi,07)
	lnImpOrg = lnImpOrg + ImpOrg
...
@01,120 SAY DATE()
@02,030 SAY PADC("LETRAS SEGUN VENCIMIENTO",88)
@02,120 SAY TIME()
