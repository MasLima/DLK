...
lcMainProcedure=gRuta+"\Progs\Actualizaciones.fxp"
SET PROCEDURE TO (lcMainProcedure) ADDITIVE
PUSH MENU _msysmenu
...
PUBLIC gCodEmpDes,gNomEmpDes,gRutEmpDes,gdbcontaDes,gPath

goApp=CREATEOBJECT("cApplication")
gNomApp = "Aplicacion Administrativa"
gCodApl = "APLIADMI"
gNomUsu = SPACE(01)
STORE "" TO gCodEmpDes,gNomEmpDes,gRutEmpDes,gdbcontaDes,gPath
