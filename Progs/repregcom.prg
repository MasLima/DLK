...
*Reg  Dia        Documento         RUC          Proveedor                            V.Venta        I.G.V.       V.Venta        I.G.V.      Inafecto         Otros       P.Venta 
*                Ser  Nro                                                        Con Derecho   Con Derecho   Sin Derecho   Sin Derecho                    Tributos
*1234 12/12/1234 1234 123456789012 123456789012 123456789012345678901234567890 99,999,999.99 99,999,999.99 99,999,999.99 99,999,999.99 99,999,999.99 99,999,999.99 99,999,999.99
...
LOCAL lnTotImpVta, lnTotImpIgv, lnTotImpIna, lnTotInpTot, lnTotImpVta2, lnTotmpIgv2, lnTotImpOtt
LOCAL lnDocImpVta, lnDocImpIgv, lnDocImpIna, lnDocInpTot, lnDocImpVta2, lnDocImpIgv2, lnDocImpOtt
@00,01 SAY CHR(15)
lnTotImpVta = 0
lnTotImpIgv = 0
lnTotImpIna = 0
...
DO WHILE !EOF() AND TipDoc = lcTipDoc
	...
	IF R > 55
		...
		@R,163 SAY lnTotImpTot  PICTURE "99,999,999.99"
		Tit_RegCom()
		R = R + 1
	ENDIF
	...
	@R,079 SAY ImpVta  PICTURE "99,999,999.99"
	@R,093 SAY ImpIgv  PICTURE "99,999,999.99"
	...
	@R,163 SAY ImpTot  PICTURE "99,999,999.99"
...
@R,163 SAY lnDocImpTot  PICTURE "99,999,999.99"
R = R + 1
ENDDO
R = R + 1
@R,001 SAY REPLICATE("-",180)
...
@01,170 SAY DATE()
@02,030 SAY PADC("R E G I S T R O   DE   C O M P R A S",140)
@02,170 SAY PADL(ALLTRIM(TTOC(DATETIME(),2)),10)
@03,030 SAY PADC(pTitulo,140)
@03,170 SAY PADL(ALLTRIM(STR(pPagAnt+lnPag)),10)
